...
const RightSidebar = () => {
    const { gitHubSignUp, googleSignUp, user } = useContext(AuthContext)
        ...
        <div className="space-y-4">
            {
                !user && <div className="flex flex-col gap-4">
                    ...
                    <button onClick={handleGitHub} aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
