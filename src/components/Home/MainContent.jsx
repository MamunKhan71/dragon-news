                                ...
                                <div className="space-y-4 border rounded-t-md">
                                    <div className="bg-[#E7E7E7] text-[#403F3F] p-4 rounded-t-md flex gap-2 items-center justify-between">
                                        <div className="flex gap-2">
                                            ...
                                            <div>
                                                <p className="font-bold">{nws.author.name}</p>
                                                <p>{moment(nws.author.published_date).format('YYYY-MM-DD')}</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-5">
                                        <h1 className="text-[#403F3F] font-bold text-xl">{nws.title}</h1>
                                        <img className="w-full object-cover" src={nws.image_url} alt="" />
                                        <div>
                                            <ReadMoreReact className="text-justify font-medium text-[#706F6F]" text={nws.details} />
                                        </div>
                                        <hr />
                                        <div className="flex items-center justify-between">
                                            <div className="flex gap-2">
                                                <Rating style={{ maxWidth: 100 }} value={Math.floor(nws.rating.number)} />
                                                <span className="text-[#706F6F] font-medium">{nws.rating.number}</span>
                                            </div>
                                            <div className="flex gap-2 items-center">
                                                ...
                                                <span className="text-[#706F6F] font-medium">{nws.total_view}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
